...
//Ported to ESP32
  ...
  // LittleFS has higher priority than SPIFFS
    ...
    //#if ( ESP_ARDUINO_VERSION >= ESP_ARDUINO_VERSION_VAL(2, 0, 0) )  //(ESP_ARDUINO_VERSION_MAJOR >= 2)
      ...
      #include "..\lib\LittleFS\src\LittleFS.h"       // https://github.com/espressif/arduino-esp32/tree/master/libraries/LittleFS
      ...
      // The library has been merged into esp32 core from release 1.0.6
      #include <..\lib\LittleFS_esp32\src\LITTLEFS.h>       // https://github.com/lorol/LITTLEFS
...
#include <ESP8266WiFi.h>          //https://github.com/esp8266/Arduino
  ...
  #if USE_LITTLEFS
    #include "..\lib\LittleFS\src\LittleFS.h"
    FS* filesystem = &LittleFS;
    #define FileFS    LittleFS
    #define FS_Name       "LittleFS"
  #else
...
void heartBeatPrint()
{
  ...
  if (WiFi.status() == WL_CONNECTED)
    Serial.print(F("."));        // . means connected to WiFi
  else
